    ...
    <div className="page">
      ...
      <section className="section why-section">
        <div className="why-text">
          <span className="eyebrow">Why CodeKidzz</span>
          <h2>Software runs the world. Let's teach kids to build it.</h2>
          <p>Tech careers are growing fast — we turn screen time into real, buildable skills.</p>
          <Link className="primary-btn" to="/enroll">Get Started</Link>
        </div>
        <div className="stats-grid stats-animated" ref={animatedStatsRef}>
          {stats.map((item) => (
